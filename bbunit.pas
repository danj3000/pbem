...
type
  TBloodbowl = class(TForm)
    ...
    procedure lblTurnBlue1Click(Sender: TObject);
    procedure DoTurnClick(Sender: TObject; team: integer; turnnumber: integer);
    procedure lblTurnRed1Click(Sender: TObject);
  private
...
uses unitRoster, unitLog, unitAbout, unitArmourRoll, unitNotes,
  ...
  unitSettings, unitMessage, gate, logPlayback;
...
begin
  ...
  curteam := -1;
  // Turn markers
  // this is a bit of a fudge until turnchange can be updated
  turn[0,1] := lblTurnRed1;
  turn[0,2] := lblTurnRed2;
  turn[0,3] := lblTurnRed3;
  turn[0,4] := lblTurnRed4;
  turn[0,5] := lblTurnRed5;
  turn[0,6] := lblTurnRed6;
  turn[0,7] := lblTurnRed7;
  turn[0,8] := lblTurnRed8;
  turn[1,1] := lblTurnBlue1;
  turn[1,2] := lblTurnBlue2;
  turn[1,3] := lblTurnBlue3;
  turn[1,4] := lblTurnBlue4;
  turn[1,5] := lblTurnBlue5;
  turn[1,6] := lblTurnBlue6;
  turn[1,7] := lblTurnBlue7;
  turn[1,8] := lblTurnBlue8;
  for g := 0 to 1 do begin
...
procedure TBloodbowl.lblTurnBlue1Click(Sender: TObject);
begin
  DoTurnClick(Sender, 1, (Sender As TLabel).Tag);
end;

procedure TBloodbowl.lblTurnRed1Click(Sender: TObject);
begin
  DoTurnClick(Sender, 0, (Sender As TLabel).Tag)
end;

procedure TBloodbowl.DoTurnClick(Sender: TObject; team: integer; turnnumber: integer);
